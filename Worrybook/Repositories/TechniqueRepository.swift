...
class TechniqueRepository {
    ...
    private var data = [
        TechniqueViewModel(title: "Box breathing", description: "Breath in for 4 seconds, hold for 4 seconds, out for 4 seconds."),
        ...
        TechniqueViewModel(title: "Worry Diary", description: "Try to think about what's worrying you and why, and write it down on paper or in this app. If you don't know, write that too! Record when and where it happend, how you felt, and how intense it was."),
        TechniqueViewModel(title: "Worry Time", description: "Set aside 10-15 minutes daily to review your worry diary. If it doesn't worry you anymore, delete or destroy it. If it does, write it again and consider if you can address it.")
    ]
